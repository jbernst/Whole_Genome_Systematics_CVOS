...
Actually running NANUQ is quite easy. An exmaple code is below (and can also be found in the [Phylogenetic-Analyses/PhyloNet.R](Phylogenetic-Analyses/PhyloNet.R) file:
